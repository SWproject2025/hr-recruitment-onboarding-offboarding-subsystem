...
__decorate([
    ...
    __metadata("design:type", mongoose_2.Types.ObjectId)
], Position.prototype, "reportingLine", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: String }),
    __metadata("design:type", String)
...
], Position.prototype, "active", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: Date, default: () => new Date() }),
    __metadata("design:type", Date)
], Position.prototype, "startDate", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: Date, default: null }),
    __metadata("design:type", Object)
], Position.prototype, "endDate", void 0);
...
exports.PositionSchema.pre('save', async function (next) {
    try {
        ...
        doc.reportingLine = await resolveDepartmentHead(DepartmentModel, doc.departmentId, doc._id);
        next();
    }
    catch (error) {
        next(error);
