...
let JwtStrategy = class JwtStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy) {
    ...
    constructor(configService, employeeSystemRoleModel, employeeProfileModel) {
        super({
    ...
    async validate(payload) {
        ...
        if (!employeeProfile) {
            throw new common_1.UnauthorizedException('Employee profile not found');
        }
...
exports.JwtStrategy = JwtStrategy = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof config_1.ConfigService !== "undefined" && config_1.ConfigService) === "function" ? _a : Object, mongoose_2.Model,
        mongoose_2.Model])
], JwtStrategy);
